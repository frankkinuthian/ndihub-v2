...
export const enrollmentType = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      description: "The amount paid for the course enrollment",
    }),
    defineField({
      name: "currency",
      title: "Currency",
      type: "string",
      description: "Currency code for the payment (e.g., KES, USD)",
      initialValue: "KES",
      validation: (rule) => rule.required(),
    }),
    defineField({
      ...
      type: "string",
      validation: (rule) => rule.required(),
      description: "The payment/checkout session ID (Stripe or IntaSend)",
    }),
    defineField({
      name: "enrolledAt",
      title: "Enrolled At",
